...
# Mean-reversion features (durable signal in EU as in US)
MR_FEATURES = [
...
# JSE-specific: spectral_low_freq_ratio had +0.044 corr at 60d, worth including
DSP_FEATURES = ["spectral_low_freq_ratio"]
FEATURES = MR_FEATURES + XS_FEATURES + VOL_FEATURES + VOL_FEAT + DSP_FEATURES
