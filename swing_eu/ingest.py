...
from swing_eu.config import BARS_DIR, START_DATE, END_DATE, UNIVERSE_SIZE
from swing_eu.universe import get_universe
from swing_eu.yf_client import fetch_daily_bars
...
def ingest_universe(tickers: list[str], start: str, end: str | None) -> dict:
    ...
    for ticker in tqdm(tickers, desc="Ingesting EU"):
